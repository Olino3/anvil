---
name: anvil-sprint
description: Break a ROADMAP phase into a sprint with granular tickets by invoking the pm agent
user-invocable: true
---
...
Invoke `@pm` (where supported) or run `apm run anvil:sprint --param phase=<phase>` with:
...
The agent will explore the codebase, create tickets, and write the sprint README.
